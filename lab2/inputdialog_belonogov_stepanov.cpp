...
InputDialog_Belonogov_Stepanov::InputDialog_Belonogov_Stepanov(QWidget* pwgt): QDialog(pwgt)
{
...
QString InputDialog_Belonogov_Stepanov::firstName() const
{
    return m_ptxtFirstName->text();
}

QString InputDialog_Belonogov_Stepanov::lastName()const
{
